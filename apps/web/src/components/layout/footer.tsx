...
const footerLinks = {
  ...
  developers: [
    ...
    { name: 'Publish a Package', href: '/docs/publishing' },
  ...
  company: [
    ...
    { name: 'Status', href: 'https://status.mcpsearch.com' },
  ],
  legal: [
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-5">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="mt-4 flex space-x-4">
              <a
                href="https://github.com/mcpsearch"
                target="_blank"
              ...
              <a
                href="https://twitter.com/mcpsearch"
                target="_blank"
                rel="noopener noreferrer"
                className="text-muted-foreground hover:text-foreground transition-colors"
                aria-label="Twitter"
        ...
        <div className="mt-12 border-t pt-8">
          <p className="text-center text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} MCPSearch. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
